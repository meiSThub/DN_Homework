 ...
 *
 * @description:在Sqlserver数据库中，实现对Department表的插入查询操作
 */
...
public class SqlserverDepartmentDao implements IDepartmentDao {
    ...
    public void insert(Department department) {
        System.out.println("在Sqlserver数据库中，增加部门（Department）数据");
    }

    @Override
    public Department query(int id) {
        System.out.println("在Sqlserver数据库中，根据id查询部门（Department）数据");
        return null;
    }
}
