...
public class CustomTextView extends RelativeLayout {
    ...
    public CustomTextView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnTextViewClickListener != null) {
                    mOnTextViewClickListener.OnTextViewClick();
                }
            }
        });
    }
    ...
    private void initAttr(AttributeSet attrs, int defStyleAttr) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable.CustomTextView, defStyleAttr, 0);
    ...
    public CustomTextView setLeftTv(String tvStr, String tvColor) {
        leftTvString = TextUtils.isDigitsOnly(tvStr) ? leftTvString : tvStr;
    ...
    public CustomTextView setBottomLine(String color) {
        bottomcolor = TextUtils.isDigitsOnly(color) ? bottomcolor : Color.parseColor(color);
        if (bottomView == null) {
            initBottomLine();
        } else {
    ...
    private void initLeftImg() {
        ...
        leftIV.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnTextViewClickListener != null) {
                    mOnTextViewClickListener.OnLeftImgClick();
                }
            }
        });
        addView(leftIV);
    ...
    private void initCenterTv() {
        ...
        LayoutParams centerTvParams = new LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.WRAP_CONTENT);
        centerTvParams.addRule(centerTVMarginleft != 0 && !TextUtils.isEmpty(leftTvString) ?
                        RelativeLayout.RIGHT_OF : RelativeLayout.CENTER_IN_PARENT,
                centerTVMarginleft != 0 && !TextUtils.isEmpty(leftTvString) ? R.id.leftTv : TRUE);
    ...
    private void initLeftTopTv() {
        ...
        leftTopTv.setTextSize(leftTopTvSize);
        leftTopTv.setTextColor(leftTopTvColor);
        leftTopTv.setText(leftTopTvString);
        addView(leftTopTv);
    }
    ...
    private void initLeftBottomTv() {
        ...
        leftBottomTv.setTextSize(leftBottomTvSize);
        leftBottomTv.setTextColor(leftBottomTvColor);
        leftBottomTv.setText(leftBottomTvString);
    ...
    private void initRightImg() {
        ...
        rightIV.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnTextViewClickListener != null) {
                    mOnTextViewClickListener.OnRightImgClick();
                }
            }
        });
        addView(rightIV);
    ...
    private void initRightTv() {
        ...
        rightTv.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (mOnTextViewClickListener != null) {
                    mOnTextViewClickListener.OnRightTvClick();
                }
            }
        });
